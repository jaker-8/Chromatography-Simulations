...
for flowind, flow in enumerate(flows):
    ...
    for concind, conc in enumerate(concs):
            ...
            adsorbers = [adsorber1,adsorber2,adsorber3]
            ...
            for thresind, thresh in enumerate(threshs):
                ...
                labels = ['Adsorber 1', 'Adsorber 2', 'Adsorber 3', 'Surge Vessel Conc.', 'Feed Conc.', 'Threshold Conc.', 'Harvest Flow Rate']
...
wastes_data.to_excel('Regen Time Tank 3-Col Run Wastes.xlsx', index = False, header = False)
prods_data.to_excel('Regen Time Tank 3-Col Run Prods.xlsx', index = False, header = False)
volume_data.to_excel('Regen Time Tank 3-Column Volumes.xlsx', index = False, header = False)
